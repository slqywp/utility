...
public class EmailUtil
{
    ...
    public EmailUtil(boolean debug)
    {
        ...
        this.mailHost = "mail.smtp.host";
        this.port = Integer.valueOf("mail.smtp.port");
        this.auth = Boolean.parseBoolean("mail.smtp.auth");
        this.sender_username = "mail.sender.username";
        this.sender_password = "mail.sender.password";
